...
pitch_locations_value <- function(pitch, velo, release_extend, release_height, hmove, vmove, handedness)
{
  ...
  data.predict_barrel$Barrel <- (exp(lp) / (1 + exp(lp))) * .5
...
pitches <- data.frame('Pitch_Type' = c("FF","FT","SL","CU","CH"),
                      "Velocity" = c(90,88,81,78,83),
                      "Release_Extension" = c(6,6,6,6,6),
                      "Release_Height" = c(round(5.86,2),round(5.86,2),round(5.86,2),round(5.86,2),round(5.86,2)),
                      "Horizontal_Movement" = c(10,12,-12,-5,15),
                      "Vertical_Movement" = c(17,14,-2,-5,10)
)
```
...
pitch <- data.frame("player_name" = "Joe Random",
                    "pitch_type" = "FF",
...
```{r pitch5, echo = FALSE, warning=FALSE}
test <- pitch_comps(pitches[5,"Pitch_Type"],pitches[5,"Velocity"],pitches[5,"Release_Extension"],pitches[5,"Release_Height"],pitches[5,"Horizontal_Movement"],pitches[5,"Vertical_Movement"])

pitch <- data.frame("player_name" = "Joe Random",
                    "pitch_type" = pitches[5,"Pitch_Type"],
                    "Velocity" = pitches[5,"Velocity"],
                    "release_extension" = pitches[5,"Release_Extension"], 
                    "Release_z" = pitches[5,"Release_Height"]
                    ,"pfx_x" = pitches[5,"Horizontal_Movement"]
                    ,"pfx_z" = pitches[5,"Vertical_Movement"]
                    , "Whiff" = NA
                    ,"Barrel" = NA
                    , "xRV_plus" = NA
                    )
...
```{r locations5, echo = FALSE, warning=FALSE}
pitch_locations(pitches[5,"Pitch_Type"],pitches[5,"Velocity"],pitches[5,"Release_Extension"],pitches[5,"Release_Height"],pitches[5,"Horizontal_Movement"],pitches[5,"Vertical_Movement"],"L")
pitch_locations(pitches[5,"Pitch_Type"],pitches[5,"Velocity"],pitches[5,"Release_Extension"],pitches[5,"Release_Height"],pitches[5,"Horizontal_Movement"],pitches[5,"Vertical_Movement"],"R")
```
<br>
...
ft <- pitch_locations_value(pitches[3,"Pitch_Type"],pitches[3,"Velocity"],pitches[3,"Release_Extension"],pitches[3,"Release_Height"],pitches[3,"Horizontal_Movement"],pitches[3,"Vertical_Movement"],"L") +labs(title="Two Seam v Left")
...
cu <- pitch_locations_value(pitches[4,"Pitch_Type"],pitches[4,"Velocity"],pitches[4,"Release_Extension"],pitches[4,"Release_Height"],pitches[4,"Horizontal_Movement"],pitches[4,"Vertical_Movement"],"L") +labs(title="Curveball v Left")

ch <- pitch_locations_value(pitches[5,"Pitch_Type"],pitches[5,"Velocity"],pitches[5,"Release_Extension"],pitches[5,"Release_Height"],pitches[5,"Horizontal_Movement"],pitches[5,"Vertical_Movement"],"L") +labs(title="Change-up v Left")
...
ft_r <- pitch_locations_value(pitches[2,"Pitch_Type"],pitches[2,"Velocity"],pitches[2,"Release_Extension"],pitches[2,"Release_Height"],pitches[2,"Horizontal_Movement"],pitches[2,"Vertical_Movement"],"R") +labs(title="Two Seam v Right")

Sl_r <- pitch_locations_value(pitches[3,"Pitch_Type"],pitches[3,"Velocity"],pitches[3,"Release_Extension"],pitches[3,"Release_Height"],pitches[3,"Horizontal_Movement"],pitches[3,"Vertical_Movement"], "R") +labs(title="Slider v Right")

cu_r <- pitch_locations_value(pitches[4,"Pitch_Type"],pitches[4,"Velocity"],pitches[4,"Release_Extension"],pitches[4,"Release_Height"],pitches[4,"Horizontal_Movement"],pitches[4,"Vertical_Movement"],"R") +labs(title="Curveball v Right")

ch_r <- pitch_locations_value(pitches[5,"Pitch_Type"],pitches[5,"Velocity"],pitches[5,"Release_Extension"],pitches[5,"Release_Height"],pitches[5,"Horizontal_Movement"],pitches[5,"Vertical_Movement"],"R") +labs(title="Change-up v Right")
